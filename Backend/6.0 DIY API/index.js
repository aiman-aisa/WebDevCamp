...
app.delete("/all", (req, res) => {
  ...
  if (userKey === masterKey) {
    ...
    res.status(404).json({
      error: `You are not authorised to perform this action, please provide a master key.`,
    });
  }
});
